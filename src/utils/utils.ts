...
import {BlockchainType, TokenType} from "./enum";
...
const validateCryptoAddress = (address: string, blockchainType?: BlockchainType, env: string = 'dev') => {
    // console.log("addr: ", address, " - ", coinType);
    let coinType = blockchainType==BlockchainType.ETH ? 'ETH':'BTC';
