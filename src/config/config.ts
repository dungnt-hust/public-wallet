...
export const config = {
  ...
  send_grid: {
    ...
    template_id_verify_transfer: process.env.SENDGRID_TEMPLACE_VERIFY_TRANSFER,
  },
  ...
  secret_key_encrypt: process.env.SECRET_KEY_ECRYPT,
  url_get_nfts : "https://explorer-testnet.onuschain.io/api?module=account&action=tokenlist"
};
